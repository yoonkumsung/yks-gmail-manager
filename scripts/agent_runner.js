...
[금지 표현 — 이 중 하나라도 출력하면 전체 결과 무효 처리됨]
아래 표현은 어떤 변형이든 절대 사용 금지:
- "확인할 수 있다" / "확인 가능하다" / "확인해 보세요"
- "링크를 통해" / "링크에서" / "해당 링크"
- "원문 참조" / "원문에서 확인" / "본문 참고"
- "자세한 내용은" / "상세 내용은" / "더 알아보기"
- "본문에 포함되지 않았으나" / "구체적인 내용은"

[정보 부족 시 올바른 처리법]
- 제목과 한 줄 설명만 있는 아이템 → 그 내용만 짧게 서술하고 마침표로 끝낸다.
- 원문 링크가 있으면 반드시 link 필드에 URL을 추출한다 (빈 문자열 금지).
- "=== 원문 기사 전문 ===" 영역이 있으면 그 내용을 적극 활용하여 풍부한 요약을 작성한다.
- 잘못된 예: "자세한 내용은 링크를 통해 확인할 수 있다."
- 올바른 예: "마스터카드 경제연구소가 파리를 국제선 입국 항공 여객 증가율 1위로 선정했다."
- 원칙: 모르는 것은 쓰지 않는다. "어디서 확인하라"고 안내하지 않는다.`,
        temperature: 0.1,
        reasoningEffort: 'low',
