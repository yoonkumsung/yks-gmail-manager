...
4. 원문 기사 전문(=== 원문 기사 전문 ===)이 있으면 적극 활용. 같은 입력 안에 어떤 기사의 짧은 티저(본문 요약)와 그 기사의 원문 전문(=== 원문 기사 전문 === 아래 --- URL --- 블록)이 함께 있으면, 둘을 합쳐 하나의 아이템으로만 추출하고 전문 내용을 우선한다. 절대 같은 기사를 티저용·전문용 2개로 분리 추출하지 말 것.
5. link 필드에 URL 반드시 추출. 원문 전문이 있는 기사는 그 전문 블록의 --- URL --- 을 link로 사용.
