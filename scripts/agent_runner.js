...
- 설문/피드백 요청
- 연말 결산/어워즈/베스트 (인기 글 순위, 클릭 순위, 연간 회고 등)
이런 메일은 { "items": [] }를 출력하세요. 억지로 아이템을 만들지 마세요.

[하나의 주제를 여러 카테고리로 나눈 콘텐츠] 하나의 메일이 같은 주제를 여러 관점/카테고리로 나눠 소개하는 경우(예: "오픈률 순위 + 클릭률 순위 + 반응 순위"), 카테고리별로 쪼개지 말고 전체를 1개 아이템으로 통합하세요.
