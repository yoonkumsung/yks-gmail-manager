...
### ⚠️ NYT 요약 시 주의사항
- NYT 뉴스레터는 제목+1~2문장 티저만 제공하는 아이템이 많음
- 티저가 짧으면 **있는 내용만 짧게 쓰고 마침표로 끝냄**
- 절대 금지: "확인할 수 있다", "링크를 통해", "자세한 내용은", "본문에 포함되지 않았으나"
- Wirecutter 제품 아이템: 제품명과 추천 이유만 간략히. 구매 안내 불필요
- 잘못된 예: "해당 링크에서 확인 가능하다." → 올바른 예: "NYT가 여름 독서 리스트 10선을 발표했다."
